...
const MyGoalDetail = () => {
  ...
  if (error || !goal)
    return <div className="text-center mt-20 text-red-500 dark:text-red-400 font-semibold">{error}</div>;
  ...
  return (
    <div className="max-w-5xl mx-auto w-full pb-24 md:pb-10 pt-6 px-4 md:px-8 relative bg-white dark:bg-gray-900 min-h-screen">
      {showConfetti && (
      ...
      <div className="flex items-center gap-4 mb-6">
        <button
          ...
          className="p-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-700 shadow-sm"
        >
          <ArrowLeft size={24} className="text-gray-900 dark:text-white" />
        </button>
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Hedef Detayı</h1>
          {goal.isShared && (
      ...
      <div className="bg-white dark:bg-gray-800 p-6 rounded-[24px] shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col md:flex-row gap-6 items-center mb-8">
        <div className="flex-1 w-full">
          <div className="flex justify-between items-center mb-3">
            <span className="text-gray-500 dark:text-gray-400 font-medium text-sm">Genel İlerleme</span>
        ...
        <div className="flex gap-2 w-full md:w-auto">
          <button
            ...
            className="bg-red-50 dark:bg-red-900/30 text-red-600 dark:text-red-400 px-5 py-4 rounded-xl font-bold hover:bg-red-100 dark:hover:bg-red-900/50 transition-colors"
          >
      ...
      {goal.contributors && goal.contributors.length > 0 && (
        <div className="bg-white dark:bg-gray-800 rounded-[24px] border border-gray-100 dark:border-gray-700 shadow-sm p-6 mb-8">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-center mb-1">
                      ...
                      <span className="text-sm font-bold text-[#007AFF]">
                        ...
                        <span className="text-gray-400 dark:text-gray-500 font-normal ml-1 text-xs">(%{pct})</span>
                      </span>
                    </div>
      ...
      {!goal.isShared && (
        <div className="mb-8">
          ...
          <button
            ...
            className="w-full sm:w-1/2 bg-gray-50 dark:bg-gray-800 p-4 rounded-xl border-2 border-dashed border-gray-200 dark:border-gray-600 flex items-center gap-4 hover:border-[#007AFF] hover:bg-blue-50/50 dark:hover:bg-blue-900/20 transition-all group text-left"
          >
            <div className="w-12 h-12 rounded-full flex items-center justify-center bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 group-hover:border-[#007AFF] group-hover:text-[#007AFF] text-gray-400 transition-colors shadow-sm">
              <Key size={24} strokeWidth={2.5} />
            </div>
            <div className="flex-1">
              <h4 className="font-bold text-gray-600 dark:text-gray-300 group-hover:text-[#007AFF]">
                Davet Kodu Üret
              </h4>
              <p className="text-sm text-gray-400 dark:text-gray-500">Arkadaşlarını ortak hedefe davet et</p>
            </div>
          </button>
        </div>
      )}
      ...
      <div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-[24px] border border-gray-100 dark:border-gray-700 overflow-hidden">
          {goal.history.length === 0 ? (
            <p className="text-center text-gray-400 dark:text-gray-500 py-8 font-medium">
              Henüz bir işlem yok.
            </p>
          ) : (
            goal.history.map((item, index) => (
              <div
                ...
                className={`flex items-center gap-4 p-4 ${
                  index < goal.history.length - 1 ? "border-b border-gray-50 dark:border-gray-700" : ""
                }`}
              >
                <div
      ...
      {isShareModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          <div className="bg-white dark:bg-gray-800 rounded-3xl w-full max-w-sm shadow-2xl p-6 text-center animate-in fade-in zoom-in-95 relative">
            <button
              onClick={() => setIsShareModalOpen(false)}
              className="absolute top-4 right-4 text-gray-400 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300"
            >
              <X size={20} />
            </button>
            ...
            <div className="bg-gray-50 dark:bg-gray-700 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-2xl p-4 mb-6">
              <div className="text-4xl font-black tracking-widest text-gray-800 dark:text-white">
                {shareCode}
              </div>
            </div>
            <button
      ...
      {isAddMoneyOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          <div className="bg-white dark:bg-gray-800 rounded-3xl w-full max-w-sm shadow-2xl overflow-hidden animate-in fade-in zoom-in-95">
            <div className="flex justify-between items-center p-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-700/50">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
                <Wallet className="text-[#007AFF]" size={24} /> Para Ekle
              </h2>
              <button
                onClick={() => setIsAddMoneyOpen(false)}
                className="text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 p-2 rounded-full shadow-sm"
              >
                <X size={20} />
              </button>
            </div>
            <form onSubmit={(e) => handleTransaction(e, "add")} className="p-6 space-y-5">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full pl-4 pr-10 py-3 text-lg font-bold text-[#007AFF] rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 focus:border-[#007AFF] focus:ring-2 focus:ring-blue-100 outline-none transition-all"
                  />
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 dark:text-white focus:border-[#007AFF] focus:ring-2 focus:ring-blue-100 outline-none transition-all text-sm"
                />
              </div>
              ...
              {!goal.isShared && cards.length > 0 && (
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 focus:border-[#007AFF] focus:ring-2 focus:ring-blue-100 outline-none transition-all text-sm bg-white dark:bg-gray-700 dark:text-white"
                  >
      ...
      {isWithdrawOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm">
          <div className="bg-white dark:bg-gray-800 rounded-3xl w-full max-w-sm shadow-2xl overflow-hidden animate-in fade-in zoom-in-95">
            <div className="flex justify-between items-center p-6 border-b border-gray-100 dark:border-gray-700 bg-red-50/50 dark:bg-red-900/20">
              <h2 className="text-xl font-bold text-gray-900 dark:text-white flex items-center gap-2">
            ...
            <form onSubmit={(e) => handleTransaction(e, "withdraw")} className="p-6 space-y-5">
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    value={actionAmount}
                    onChange={(e) => setActionAmount(e.target.value)}
                    className="w-full pl-4 pr-10 py-3 text-lg font-bold text-red-500 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 focus:border-red-500 focus:ring-2 focus:ring-red-100 outline-none transition-all"
                  />
                  <span className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 font-semibold">
                    ₺
                  </span>
              ...
              <div>
                ...
                <input
                  ...
                  value={actionNote}
                  onChange={(e) => setActionNote(e.target.value)}
                  className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 dark:text-white focus:border-red-500 focus:ring-2 focus:ring-red-100 outline-none transition-all text-sm"
                />
              </div>
              ...
              {!goal.isShared && cards.length > 0 && (
                <div>
                  ...
                  <select
                    value={selectedCardId}
                    onChange={(e) => setSelectedCardId(e.target.value)}
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-gray-600 focus:border-red-500 focus:ring-2 focus:ring-red-100 outline-none transition-all text-sm bg-white dark:bg-gray-700 dark:text-white"
                  >
