...
const HomeHeader = () => {
  ...
  return (
    <>
      ...
      <header className="w-full bg-white dark:bg-gray-800 dark:border-gray-700 border-b border-gray-100 shadow-sm px-6 md:px-10 py-4 hidden md:flex justify-between items-center sticky top-0 z-10">
        ...
        <div className="flex items-center gap-4 md:gap-6 opacity-40 hover:opacity-100 transition-opacity duration-300 cursor-pointer shrink-0">
          ...
          <div className="relative overflow-hidden h-6 border-r border-gray-100 pr-4 md:pr-6 w-[250px] md:w-[400px] lg:w-[500px]">
            {loading ? (
              <span className="text-[10px] font-bold text-gray-400 dark:text-gray-500 animate-pulse uppercase tracking-widest absolute left-0 flex items-center h-full">
                Veriler Yükleniyor...
              </span>
            ) : rates ? (
              <div className="animate-marquee-perfect cursor-default gap-8 h-full">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[10px] font-black text-gray-700 dark:text-gray-300">USD/TRY</span>
